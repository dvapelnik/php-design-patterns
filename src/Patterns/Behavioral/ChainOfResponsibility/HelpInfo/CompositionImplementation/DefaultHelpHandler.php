...
class DefaultHelpHandler implements HelpHandlerInterface
{
    /** @var  HelpHandlerInterface */
    private $_nextHelpHandler;

    private $_helpData = 'HELP_DATA_ON_DEFAULT_HELP_HANDLER';

    private $_defaultHelpData = 'DEFAULT_HELP_DATA_ON_DEFAULT_HELP_HANDLER';
